              ...
              <div class="col-sm-3">
                <div class="single-item">
                  <div class="single-item-header">
                    <a href="chitiet/{{$new->id}}"><img width="200" height="200"
          ...
          <div class="beta-products-list">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="single-item">
                  <div class="single-item-header">
                    <a href="chitiet/{{$product->id}}"><img width="200" height="200" src="/source/image/product/{{$product->image}}" alt=""></a>
                  </div>
                  <div class="single-item-body">
                  ...
                  <div class="single-item-caption">
                    ...
                    <a class="beta-btn primary" href="chitiet/{{$product->id}}">Details <i
                        class="fa fa-chevron-right"></i></a>
                    <div class="clearfix"></div>
                  </div>
                </div>
