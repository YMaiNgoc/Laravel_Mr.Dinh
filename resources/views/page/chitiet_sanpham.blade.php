            ...
            <div class="col-sm-4">
              <div class="single-item">
                <div class="single-item-header">
                  <a href="chitiet/{{$product->id}}"><img src="/source/image/product/{{$product->image}}" alt=""></a>
                </div>
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/111.jpg"
                    alt=""></a>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/234.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/banh kem sinh nhat.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/Banh-kem.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
        ...
        <div class="widget">
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/1434429117-banh-su-kem-chien-20.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="source/image/product/1430967449-pancake-sau-rieng-6.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
