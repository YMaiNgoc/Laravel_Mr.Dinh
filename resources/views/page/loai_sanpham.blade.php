              ...
              <div class="col-sm-4">
                <div class="single-item">
                  ...
                  <div class="single-item-caption">
                    ...
                    <a class="beta-btn primary" href="{{ url('chitiet/'.$sp->id) }}">Details <i class="fa fa-chevron-right"></i></a>
              ...
              <div class="col-sm-3">
                <div class="single-item">
                  ...
                  <div class="single-item-caption">
                    ...
                    <a class="beta-btn primary" href="{{ url('chitiet/'.$khac->id) }}">Details <i class="fa fa-chevron-right"></i></a>
